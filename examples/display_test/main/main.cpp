...
void idf_loop() {
    ...
    EpdRect zebra_area = {
        .x = epd_rotated_display_width() / 2 - (int)img_zebra_width / 2,
        .y = epd_rotated_display_height() / 2 - (int)img_zebra_height / 2,
    ...
    EpdRect board_area = {
        .x = epd_rotated_display_width() / 2 - (int)img_board_width / 2,
        .y = epd_rotated_display_height() / 2 - (int)img_board_height / 2,
    ...
    font_props.flags = (EpdFontFlags)(font_props.flags | EPD_DRAW_BACKGROUND);
    ...
    EpdRect img_beach_area = {
        .x = 0,
        .y = epd_rotated_display_height() - (int)img_beach_height,
